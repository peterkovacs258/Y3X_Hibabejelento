...
<div class="form-group informationDiv">
    ...
    <span>Full Name</span><input type="text" value="<?php echo $_SESSION['name'];?>"  class="ticketFullName form-controll filled">
    <span>Email address</span><input value="<?php echo $_SESSION['email']; ?>" type="text" class="ticketEmail form-controll filled" >
    <span>Home address</span><input type="text" class="form-controll ticketHaddress" >
</div>

    <div class="productInformation">
        <h3>Product information</h3>
       <span>Product category</span>
       <select class="form-controll ticketPCategory">
       ...
       <input class="form-group form-controll ticketPName" type="text">
...
<div class="faultDiv">
    ...
    <select class="form-controll ticketFCategory">
    ...
    <textarea class="form-group ticketMessage"></textarea>
